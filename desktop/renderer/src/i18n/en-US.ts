export default {
  ...
  "sidebar.usageSnapshotTitle": "Usage",
  "sidebar.usageSnapshotViewDetails": "Details",
  "sidebar.usageSnapshotSpend": "Spend",
  "sidebar.usageSnapshotTokens": "Tokens",
  "sidebar.usageSnapshotRequests": "Requests",
  "sidebar.usageSnapshotHealth": "Health",
  "sidebar.usageSnapshotOffline": "Gateway offline",
  "sidebar.usageSnapshotNoData": "No usage data yet",
  "sidebar.usageSnapshotPeriod": "Last 30 days",
  "sidebar.usageSnapshotUpdated": "Updated {time}",
  "sidebar.usageSnapshotExpand": "Expand usage snapshot",
  "sidebar.usageSnapshotCollapse": "Collapse usage snapshot",
  "sidebar.usageSnapshotMock": "Mock data",
  "sidebar.usageSnapshotSimulated": "Simulated",
  ...
  "settings.dockerSandboxTitle": "Docker sandbox (experimental)",
  ...
  "settings.dockerWslDocs": "Microsoft WSL setup",
  "settings.dockerDesktopDocs": "Docker Desktop setup",
  "settings.dockerCheckWindows": "Supported Windows",
  "settings.dockerCheckWsl2": "Usable WSL2 distribution",
  "settings.dockerCheckDaemon": "Docker Desktop daemon",
  "settings.dockerCheckLinux": "Linux containers",
  "settings.dockerCheckImage": "Sandbox image",
  "settings.dockerReason.ready": "Ready",
  "settings.dockerReason.windows-required": "Windows required",
  "settings.dockerReason.windows-version-unsupported": "Windows version unsupported",
  "settings.dockerReason.wsl-command-missing": "WSL is not installed",
  "settings.dockerReason.wsl-feature-disabled": "WSL feature is disabled",
  "settings.dockerReason.wsl-no-distribution": "No WSL distribution",
  "settings.dockerReason.wsl2-distribution-missing": "No WSL2 distribution",
  "settings.dockerReason.wsl-kernel-update-required": "WSL kernel update required",
  "settings.dockerReason.wsl-reboot-required": "Windows restart required",
  "settings.dockerReason.wsl-check-timeout": "WSL check timed out",
  "settings.dockerReason.wsl-check-failed": "WSL check failed",
  "settings.dockerReason.docker-cli-missing": "Docker Desktop is not installed",
  "settings.dockerReason.docker-daemon-unavailable": "Docker Desktop is not running",
  "settings.dockerReason.docker-desktop-required": "Docker Desktop is required",
  "settings.dockerReason.docker-linux-containers-required": "Switch to Linux containers",
  "settings.dockerReason.docker-check-timeout": "Docker check timed out",
  "settings.dockerReason.docker-check-failed": "Docker check failed",
  "settings.dockerReason.sandbox-image-missing": "Image must be built",
  ...
  "skills.dev.refresh": "Refresh all agents",
  ...
  "agent.codeGeek.desc": "Expert engineering for app prototypes, code audits, and build failures",
  "agent.codeGeek.tag.1": "App Prototyping",
  "agent.codeGeek.tag.2": "Code Audits",
  "agent.codeGeek.tag.3": "Build Diagnostics",
  "agent.codeGeek.task.1.title": "Build this feature or web app",
  "agent.codeGeek.task.1.desc":
    "Turn the requirements into runnable, integrated code that follows the existing project.",
  "agent.codeGeek.task.2.title": "Audit this code",
  "agent.codeGeek.task.2.desc":
    "Find correctness, security, and performance issues and propose concrete fixes.",
  "agent.codeGeek.task.3.title": "Diagnose this build failure",
