export default {
  ...
  "modelSetup.selectDesc": "Choose a guided provider or configure any compatible model endpoint.",
  "modelSetup.keyDesc": "Enter your model details and API key to start using MicroClaw.",
  "modelSetup.customDesc": "Configure an OpenAI-compatible or Anthropic-compatible model endpoint.",
